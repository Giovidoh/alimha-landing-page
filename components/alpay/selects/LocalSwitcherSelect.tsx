...
const LocalSwitcherSelect = () => {
    ...
    const handleChangeLanguage = () => {
        if (localActive == "en") {
            router.replace(`/fr/alpay`);
        } else {
            router.replace(`/en/alpay`);
        }
    };
        ...
        <>
            ...
            >
                ...
                <div
                    ...
                    } absolute top-[105%] left-0 bg-white w-full px-3 py-3 border-[1px] border-t-0 border-primary-blue rounded-bl-md rounded-br-md select-none cursor-pointer -z-10`}
